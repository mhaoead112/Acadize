...
export function GeometricShapes({ variant = "section" }: ShapeProps) {
  if (variant === "hero") {
    return (
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        ...
        />
        <motion.div
          className="absolute top-52 right-[22%] w-2 h-2 rounded-full bg-amber-500/50"
        ...
        <motion.div
          className="absolute bottom-20 right-20 w-10 h-10 rounded-lg bg-amber-500/20 border border-amber-500/30"
  ...
  if (variant === "cta") {
    return (
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        ...
        />
        <motion.div
          className="absolute -bottom-10 -left-10 w-56 h-56 rounded-full bg-amber-500/10"
        ...
        />
        <motion.div
          className="absolute bottom-10 right-1/4 w-5 h-5 rotate-45 bg-amber-500/30 rounded-sm"
  ...
  if (variant === "dark") {
    return (
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        ...
        />
        <motion.div
          className="absolute -bottom-16 -left-16 w-72 h-72 rounded-full bg-amber-500/10 blur-3xl"
          animate={{ scale: [1, 1.15, 1] }}
        ...
        />
        <motion.div
          className="absolute bottom-16 right-16 w-8 h-8 rotate-45 border border-amber-500/30"
          animate={{ rotate: [45, 90, 45], y: [0, -10, 0] }}
          transition={{ repeat: Infinity, duration: 6, ease: "easeInOut" }}
        />
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      />
      <motion.div
        className="absolute bottom-10 left-[8%] w-8 h-8 rotate-45 bg-amber-500/15 rounded-sm"
