        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              ...
              <Link href="/contact">
                <motion.button 
                  className="flex h-12 items-center justify-center gap-2 rounded-lg border border-slate-300 dark:border-white/20 bg-white dark:bg-background-secondary px-8 text-base font-bold text-slate-900 dark:text-white transition-all"
          ...
          >
            ...
            <motion.div 
              className="relative rounded-xl border border-white/10 bg-background-secondary shadow-2xl overflow-hidden aspect-[4/3] group"
              whileHover={{ 
                rotateY: 5, 
                rotateX: -5,
                scale: 1.02,
            ...
            >
              {/* Fake Browser Header */}
              <div className="flex items-center gap-2 border-b border-white/10 bg-background-dark/50 px-4 py-3">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-t from-background-secondary/90 via-transparent to-transparent opacity-60"></div>
              </div>
...
const FloatingBadge: React.FC<{ icon: React.ReactNode; text: string; delay: number }> = ({ icon, text, delay }) => (
  <motion.div 
    className="bg-white/90 dark:bg-background-dark/90 backdrop-blur border border-slate-200 dark:border-white/10 px-3 py-1.5 rounded-lg flex items-center gap-2 shadow-lg"
