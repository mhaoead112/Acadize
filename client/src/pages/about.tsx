...
export default function About() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero / Mission */}
      <section className="bg-muted/30 pt-32 pb-20 border-b relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl relative z-10">
          ...
          >
            <div className="mb-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary font-semibold text-sm">
              Our Mission
            </div>
          ...
          <MascotFloat src={mascotWaving} alt="Waving Mascot" className="absolute top-12 right-4 lg:right-12 w-36 drop-shadow-2xl z-10 hidden md:block" animation="spin-float" />
        </div>
      </section>
      ...
      <section className="py-24 bg-background relative z-0">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <div className="prose prose-lg text-muted-foreground dark:prose-invert max-w-none space-y-4">
            <p>
      ...
      <section className="py-20 bg-muted/30 border-t">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-4">
            <Link href="/contact"><Button size="lg" variant="outline">View Open Roles</Button></Link>
