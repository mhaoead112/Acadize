...
import { CheckCircle2, Shield, Lock, Cloud, Zap, BookOpen, MessageSquare, ClipboardCheck, BarChart3, Settings } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: Zap, title: "AI Assistant", color: "bg-yellow-100 dark:bg-yellow-950/40 text-yellow-600 dark:text-amber-400", desc: "Smart tools to help teachers generate lesson plans, grade essays, and provide personalized feedback." },
      ...
      <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <Link href="/contact">
            <Button size="lg" className="bg-white text-primary hover:bg-white/90 text-lg h-14 px-10 shadow-xl font-bold">
              Book a Demo
            </Button>
          </Link>
        </div>
