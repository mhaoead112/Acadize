          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            ...
            >
              ...
              <motion.div variants={fadeIn} className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-muted-foreground font-medium">
                ...
                <div className="flex items-center gap-2"><Zap className="w-5 h-5 text-amber-500" /> AI-Powered</div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 to-amber-500/20 rounded-full blur-3xl -z-10 transform scale-110"></div>
              ...
              >
                ...
                <div className="text-2xl font-bold text-foreground flex items-center gap-2">
                  9.5 <span className="text-amber-500 text-lg">★★★★★</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-background overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div className="mb-6 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/20 text-yellow-700 dark:text-amber-400 font-medium text-sm">
                <Zap className="w-4 h-4" />
                Acadize AI
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-primary-foreground/80 font-medium">Students</div>
            </div>
            <div>
              <div className="text-4xl md:text-5xl font-black mb-2">50k+</div>
              <div className="text-primary-foreground/80 font-medium">Teachers</div>
            </div>
            <div>
              <div className="text-4xl md:text-5xl font-black mb-2">1,200+</div>
              <div className="text-primary-foreground/80 font-medium">Schools</div>
            </div>
            <div>
              <div className="text-4xl md:text-5xl font-black mb-2">99%</div>
              <div className="text-primary-foreground/80 font-medium">Satisfaction</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-background relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-10 lg:p-16 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-amber-500/20 rounded-full blur-3xl -z-10 transform -translate-x-1/2 translate-y-1/2"></div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/contact">
                <Button size="lg" className="w-full sm:w-auto text-lg h-14 px-10 bg-primary hover:bg-primary/90 text-primary-foreground shadow-xl hover:shadow-2xl transition-all border-none font-bold">
                  Book a Demo
                </Button>
              </Link>
              <Link href="/pricing">
