...
export default function Solutions() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero */}
      <section className="bg-background pt-32 pb-20 border-b relative overflow-hidden">
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <Link href="/contact">
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg h-14 px-10 shadow-xl border-none font-bold">
              Talk to Sales
            </Button>
          </Link>
